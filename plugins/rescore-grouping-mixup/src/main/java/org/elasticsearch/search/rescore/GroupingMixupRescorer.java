...
public class GroupingMixupRescorer implements Rescorer {
    ...
    private static final Comparator<ScoreDoc> DOC_COMPARATOR = new Comparator<ScoreDoc>() {
        @Override
    ...
    public static class Context extends RescoreSearchContext {
        ...
        public Context(GroupingMixupRescorer rescorer,
                       String groupingField,
                       SearchScript declineScript) {
            super(GroupingMixupRescorerBuilder.NAME.getPreferredName(),
                  DEFAULT_WINDOW_SIZE,
                  rescorer);
